...
<div class="prestasi-calon-form">
    ...
    <?= $form->field($model, 'id_calon')->dropDownList($model::dropdown(),
    	['prompt' => 'Pilih Calon Peserta']
    	) ?>

    <?= $form->field($model, 'nama_kejuaraan')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tingkat')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'juara')->textInput() ?>
